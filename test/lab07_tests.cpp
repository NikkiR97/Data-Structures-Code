...
TEST_F(TreeFixture, construct_with_check_size) { //works
    EXPECT_EQ(tree->size(), 0);
    EXPECT_EQ(tree->depth(), 0);
}


TEST_F(TreeFixture, depth) //works
{
...
TEST_F(TreeFixture, frequency) //works
{
...
TEST_F(TreeFixture, level) //works
{
...
TEST_F(TreeFixture, in_tree) //works
{
...
TEST_F(TreeFixture, path_to) //works
{
...
TEST_F(TreeFixture, print) //works
{
testing::internal::CaptureStdout();
built_tree->print();
std::string output = testing::internal::GetCapturedStdout();
...
TEST_F(TreeFixture, remove_mult) //has an issue with the size
{
built_tree->insert(6);
...
TEST_F(TreeFixture, remove_single) //has an issue with get frequency
{
EXPECT_EQ(built_tree->get_frequency(6), 1);
EXPECT_EQ(built_tree->remove(6), true);
...
TEST_F(TreeFixture, remove_nonexistant) //works
{
EXPECT_EQ(built_tree->get_frequency(21), 0);
...
TEST_F(TreeFixture, remove_parent) //works
{
EXPECT_EQ(built_tree->get_frequency(4), 1);
...
TEST_F(TreeFixture, remove_root) //works
{
EXPECT_EQ(built_tree->get_frequency(12), 1);
...
TEST_F(TreeFixture, insert){ //works
tree->insert(10);
